...
@pytest.mark.parametrize(
    'name',
    (
        'test_topic_name', 'test_channel_name1', '123456',
        'test_topic_name#ephemeral', '__-.-__', 'TEST_TOPIC_12123-name_',
        '123123#ephemeral', 'TEST_TOPIC_CHANNEL123123-name_#ephemeral'
    )
)
...
@pytest.mark.parametrize(
    ...
    (
        ...
        'maybe try this', 'or_this_one?', '-how-about-this-\name'
    )
)
